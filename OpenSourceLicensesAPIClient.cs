...
namespace APIVerve
{
    public class OpenSourceLicensesAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/openlicenses";
        ...
        public OpenSourceLicensesAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public OpenSourceLicensesAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, OpenSourceLicensesQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(OpenSourceLicensesQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(OpenSourceLicensesQueryOptions options)
        {
